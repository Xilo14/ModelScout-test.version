...
namespace ModelScoutAPI
{
    ...
    {
        static Dictionary<VkAcc, VkApi> cachedApis = new Dictionary<VkAcc, VkApi>();

        static public AccountSaveProfileInfoParams GetProfileInfo(VkAcc vkAcc)
        {
        ...
        public static void UpdateAllAccsByUsers(ModelScoutAPI.Models.User user)
        {
        ...
        public static Boolean TryAuthorize(string accessToken)
        {
            var vkApi = new VkApi();
            vkApi.Authorize(new ApiAuthParams
            {
